...
@section('title') إضافة تصنيف @endsection
@section('css')
...
@section('content')
 ...
 @endif
 <form method="POST" action="{{route('admin.academy_size.store')}}" enctype="multipart/form-data" data-parsley-validate novalidate>
     @csrf
     @method('POST')
        <div class="row">
            <div class="col-lg-12">
