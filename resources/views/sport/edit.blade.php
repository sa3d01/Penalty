...
@section('title') تعديل بيانات رياضة @endsection
@section('css')
...
@section('content')
 @component('common-components.breadcrumb')
         ...
         @slot('li_1') تعديل بيانات رياضة  @endslot
 @endcomponent
 @if($errors->any())
 ...
 @endif
 <form method="POST" action="{{route('admin.sport.update',$row->id)}}" enctype="multipart/form-data" data-parsley-validate novalidate>
     @csrf
     @method('PUT')
        <div class="row">
            <div class="col-lg-12">
