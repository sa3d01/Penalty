...
@section('title') إضافة دولة @endsection
@section('css')
...
@section('content')
 ...
 @endif
 <form method="POST" action="{{route('admin.country.store')}}" enctype="multipart/form-data" data-parsley-validate novalidate>
     @csrf
     @method('POST')
        <div class="row">
            <div class="col-lg-12">
