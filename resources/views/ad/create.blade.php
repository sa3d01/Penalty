...
@section('title') إضافة وسيلة اعلان @endsection
@section('css')
...
@section('content')
 @component('common-components.breadcrumb')
         ...
         @slot('li_1') إضافة وسيلة اعلان  @endslot
 @endcomponent
 @if($errors->any())
 ...
 @endif
 <form method="POST" action="{{route('admin.ad.store')}}" enctype="multipart/form-data" data-parsley-validate novalidate>
     @csrf
     @method('POST')
        <div class="row">
            <div class="col-lg-12">
