...
@section('title') تعديل بيانات لاعب @endsection
@section('css')
...
@section('content')
 @component('common-components.breadcrumb')
         ...
         @slot('li_1') تعديل بيانات لاعب  @endslot
 @endcomponent
 @if($errors->any())
 ...
 @endif
 <form method="POST" action="{{route('admin.player.update',$row->id)}}" enctype="multipart/form-data" data-parsley-validate novalidate>
     @csrf
     @method('PUT')
        <div class="row">
            <div class="col-lg-6">
...
{{--                    </div>--}}
            ...
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title">بيانات لاعب</h4>
                        <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input value="{{$row->nationality}}" required type="text" class="form-control" maxlength="25" name="nationality" id="alloptions" />
                    </div>
                    <div class="form-group">
                        <label class="control-label">رقم الهوية</label>
                        <input value="{{$row->nationality_id}}" required type="text" class="form-control" maxlength="50" name="nationality_id" id="alloptions" />
                    </div>
                </div>
            </div>
            <!-- end select2 -->
